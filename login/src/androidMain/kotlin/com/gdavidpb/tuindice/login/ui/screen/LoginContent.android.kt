...
fun SignInContentScreen(
	...
	SignInScreen(
		...
		idleContent = { idleState, usbIdChange, passwordChange, signInClick, termsAndConditionsClick, privacyPolicyClick ->
			SignInIdleView(
				state = idleState,
				onUsbIdChange = usbIdChange,
				onPasswordChange = passwordChange,
				onSignInClick = signInClick,
				onTermsAndConditionsClick = termsAndConditionsClick,
				onPrivacyPolicyClick = privacyPolicyClick,
