...
object SubjectsNavContribution : TuIndiceNavContribution {

	override fun registerNavKeys(builder: PolymorphicModuleBuilder<NavKey>) {
		builder.subclass(SubjectsDestination.SubjectSearch::class)
		builder.subclass(SubjectsDestination.SubjectDetail::class)
	}
}
