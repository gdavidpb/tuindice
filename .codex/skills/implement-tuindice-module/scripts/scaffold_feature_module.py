...
TEMPLATE_FILES = {
    ...
    "action-processor": "action-processor.kt.tpl",
    "repository-interface": "repository-interface.kt.tpl",
    "repository-implementation": "repository-implementation.kt.tpl",
    "use-case": "use-case.kt.tpl",
    "use-case-error": "use-case-error.kt.tpl",
    "exception-handler": "exception-handler.kt.tpl",
...
SCAFFOLD_LAYOUT = {
    ...
    "action-processor": "{module_dir}/src/commonMain/kotlin/{package_path}/presentation/action/{ACTION_PROCESSOR_NAME}.kt",
    ...
    "use-case": "{module_dir}/src/commonMain/kotlin/{package_path}/domain/usecase/{LOAD_USE_CASE_NAME}.kt",
    "use-case-error": "{module_dir}/src/commonMain/kotlin/{package_path}/domain/usecase/error/{USE_CASE_ERROR_NAME}.kt",
    "exception-handler": "{module_dir}/src/commonMain/kotlin/{package_path}/domain/usecase/exceptionhandler/{EXCEPTION_HANDLER_NAME}.kt",
...
def build_context(args: argparse.Namespace) -> dict[str, str]:
    ...
    context = {
        ...
        "ACTION_PROCESSOR_NAME": f"Load{feature_name}ActionProcessor",
        "ACTION_PROCESSOR_PARAM_NAME": f"load{feature_name}ActionProcessor",
        "LOAD_ACTION_NAME": f"Load{feature_name}",
        "LOAD_METHOD_NAME": f"load{feature_name}Action",
        "LOAD_USE_CASE_NAME": f"Load{feature_name}UseCase",
        "LOAD_USE_CASE_PARAM_NAME": f"load{feature_name}UseCase",
        "USE_CASE_ERROR_NAME": f"Load{feature_name}UseCaseError",
        "EXCEPTION_HANDLER_NAME": f"Load{feature_name}ExceptionHandler",
        ...
        "VALIDATOR_NAME": f"Load{feature_name}ParamsValidator",
        "PARAMS_NAME": f"Load{feature_name}Params",
