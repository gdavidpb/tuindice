...
TEMPLATE_FILES = {
    ...
    "observe-action-processor": "observe-action-processor.kt.tpl",
    "refresh-action-processor": "refresh-action-processor.kt.tpl",
...
SCAFFOLD_LAYOUT = {
    ...
    "observe-action-processor": "{module_dir}/src/commonMain/kotlin/{package_path}/presentation/action/{OBSERVE_ACTION_PROCESSOR_NAME}.kt",
    "refresh-action-processor": "{module_dir}/src/commonMain/kotlin/{package_path}/presentation/action/{REFRESH_ACTION_PROCESSOR_NAME}.kt",
...
def build_context(args: argparse.Namespace) -> dict[str, str]:
    ...
    context = {
        ...
        "OBSERVE_ACTION_PROCESSOR_NAME": f"Observe{feature_name}ActionProcessor",
        "OBSERVE_ACTION_PROCESSOR_PARAM_NAME": f"observe{feature_name}ActionProcessor",
        "REFRESH_ACTION_PROCESSOR_NAME": f"Refresh{feature_name}ActionProcessor",
        "REFRESH_ACTION_PROCESSOR_PARAM_NAME": f"refresh{feature_name}ActionProcessor",
