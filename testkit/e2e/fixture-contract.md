...
- The `prioridad` search is reserved for deterministic ordering and visible availability states in the create-term search list. Its fixture must keep `EP1308` as already planned, `EP2308` as blocked but addable, and `AA1001`/`AB1001` as catalog-only subjects after pensum subjects.
