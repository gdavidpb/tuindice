...
data class ComputeSetSubjectGradeCall(
    val qid: String,
    val sid: String,
    val grade: Int
)
...
class FakeLocalDataSource(
    ...
    val computeSetSubjectGradeCalls = mutableListOf<ComputeSetSubjectGradeCall>()
    val events = mutableListOf<String>()

    var computeSetSubjectGradeResult: List<LocalQuarter> = emptyList()
    ...
    override suspend fun computeSetSubjectGrade(qid: String, sid: String, grade: Int): List<LocalQuarter> {
        computeSetSubjectGradeCalls += ComputeSetSubjectGradeCall(qid, sid, grade)
        return computeSetSubjectGradeResult
    }
}
