...
data class QuarterResponse(
	...
	@SerialName("simulation_grade") val simulationGrade: Double? = null,
	@SerialName("simulation_grade_sum") val simulationGradeSum: Double? = null,
	@SerialName("simulation_credits") val simulationCredits: Int? = null,
	@SerialName("simulation_credits_sum") val simulationCreditsSum: Int? = null,
